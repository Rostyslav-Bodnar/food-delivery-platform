import { BarChart2, Package, Filter, Users, History, LineChart } from "lucide-react";
import Sidebar from "./components/Sidebar.jsx";

export default function BusinessSidebar({ userData, disabled }) {

    const items = [
        { id: "home", label: "Home", icon: BarChart2, path: "/" },
        { id: "dashboard", label: "Dashboard", icon: LineChart, path: "/business/dashboard" },
