...
import { Bike, CheckCircle2, History, XCircle } from "lucide-react";
...
import { getCustomerOrderHistory } from "../../api/Order.ts";
...
const STATUS_META = {
    ...
    "picked-up": { text: "Picked up", color: "#4bd68a", icon: <Bike size={14} /> }
};
...
export default function CustomerOrderHistoryPage() {
    ...
    const load = useCallback(async () => {
        ...
        try {
            const data = await getCustomerOrderHistory(customerId);
        ...
        <div className="app-wrapper">
            ...
            <main className="order-history-page">
                <div className="order-history-inner">
                    ...
                    {loading ? (
                        <div className="history-loading">Loading your past orders…</div>
                    ) : filtered.length === 0 ? (
